...
<link rel="stylesheet" href="/wp-content/themes/getboost/assets/css/bootstrap.min.css">

<div class="">
	<div class="header-slide-container">
		<svg xmlns="http://www.w3.org/2000/svg" width="263.175" height="75.841" viewBox="0 0 263.175 75.841">
			<g id="Group_620" data-name="Group 620" transform="translate(0 0.07)">
...
<main id="site-content" role="main">
	<div class="container">
		<div class="row">
			...
			<div style="margin-bottom: 25px;" class="col-6 col-md-4">
				<a href=""><img src="/wp-content/themes/getboost/assets/images/youtube.png"></img></a>
			</div>

			<div class="col-6 col-md-4">
				<a href=""><img src="/wp-content/themes/getboost/assets/images/facebook.png"></img></a>
			</div>

			<div style="margin-bottom: 25px;" class="col-6 col-md-4">
				<a href=""><img src="/wp-content/themes/getboost/assets/images/instagram.png"></img></a>
			</div>

			<div class="col-6 col-md-4">
				<a href=""><img src="/wp-content/themes/getboost/assets/images/twitter.png"></img></a>
			</div>

			<div class="col-6 col-md-4">
				<a href=""><img src="/wp-content/themes/getboost/assets/images/tiktok.png"></img></a>
			</div>

			<div class="col-6 col-md-4">
				<a href=""><img src="/wp-content/themes/getboost/assets/images/in.png"></img></a>
			</div>
		</div>
	</div>
	<div class="container">
		<div style="margin-top: 100px;" class="row row_reverse">
			<div class="col-md-4">
				<img class="social-media" src="/wp-content/themes/getboost/assets/images/social-media.png"></img>
				<img class="social-socials-image" src="/wp-content/themes/getboost/assets/images/socials.png"></img>
			</div>
			<div class="col-md-8">
				<h2 class="social-title">ברוכים הבאים לגט-בוסט</h2>
				<p class="social-subtitle">.המקום הטוב ביותר לקניית עוקבים, לייקים וצפיות ברשת החברתית</p>
				<img style="float: right;" src="/wp-content/themes/getboost/assets/images/Rectangle.png"></img>
				<p class="social-text">
					לורם איפסום דולור סיט אמט, קונסקטורר אדיפיסינג אלית להאמית קרהשק סכעיט דז מא, מנכם למטכין נשואי מנורך. גולר מונפרר סוברט לורם שבצק יהול, לכנוץ בעריר גק ליץ, ושבעגט ליבם סולגק. בראיט ולחת צורק מונחף, בגורמי מגמש. תרבנך וסתעד לכנו סתשם השמה - לתכי מורגם בורק? לתיג ישבעס.

					סחטיר בלובק. תצטנפל בלינדו למרקל אס לכימפו, דול, צוט ומעיוט - לפתיעם ברשג - ולתיעם גדדיש. קוויז דומור ליאמום בלינך רוגצה. לפמעט מוסן מנת. קוואזי במר מודוף. אודיפו בלאסטיק מונופץ קליר, בנפת נפקט למסון בלרק - וענוף לפרומי בלוף קינץ תתיח לרעח. לת צשחמי צש בליא, מנסוטו צמלח לביקו ננבי, צמוקו בלוקריה שיצמה ברורק.
				</p>
				<img class="social-dots" src="/wp-content/themes/getboost/assets/images/dots.png"></img>
			</div>
		</div>

	</div>
	<div class="choose-container">
		<img class="background-image2" src="/wp-content/themes/getboost/assets/images/background-image2.png"></img>

		<div class="container text-container">
			<h2 class="title-choose-us">?למה לבחור בנו</h2>
			<div class="row">
				<div class="col-6 col-md-2">
					<img style="margin: auto;" src="/wp-content/themes/getboost/assets/images/antivirus.png"></img>
					<p class="choose-text">דיסקרטי</p>
					<p style="text-align: center;">לורם איפסום דולור סיט אמט, קונסקטורר אדיפיסינג אלית להאמית קרהשק סכעיט דז מא, מנכם למטכין נשואי מנורך. גולר </p>
				</div>
				<div class="col-6 col-md-2">
					<img style="margin: auto;" src="/wp-content/themes/getboost/assets/images/price.png"></img>
					<p class="choose-text">דיסקרטי</p>
					<p style="text-align: center;">לורם איפסום דולור סיט אמט, קונסקטורר אדיפיסינג אלית להאמית קרהשק סכעיט דז מא, מנכם למטכין נשואי מנורך. גולר </p>
				</div>
				<div class="col-6 col-md-2">
					<img style="margin: auto;" src="/wp-content/themes/getboost/assets/images/support.png"></img>
					<p class="choose-text">דיסקרטי</p>
					<p style="text-align: center;">לורם איפסום דולור סיט אמט, קונסקטורר אדיפיסינג אלית להאמית קרהשק סכעיט דז מא, מנכם למטכין נשואי מנורך. גולר </p>
				</div>
				<div class="col-6 col-md-2">
					<img style="margin: auto;" src="/wp-content/themes/getboost/assets/images/award.png"></img>
					<p class="choose-text">דיסקרטי</p>
					<p style="text-align: center;">לורם איפסום דולור סיט אמט, קונסקטורר אדיפיסינג אלית להאמית קרהשק סכעיט דז מא, מנכם למטכין נשואי מנורך. גולר </p>
				</div>
				<div class="col-6 col-md-2">
					<img style="margin: auto;" src="/wp-content/themes/getboost/assets/images/speed.png"></img>
					<p class="choose-text">דיסקרטי</p>
					<p style="text-align: center;">לורם איפסום דולור סיט אמט, קונסקטורר אדיפיסינג אלית להאמית קרהשק סכעיט דז מא, מנכם למטכין נשואי מנורך. גולר </p>
				</div>
				<div class="col-6 col-md-2">
					<img style="margin: auto;" src="/wp-content/themes/getboost/assets/images/outline.png"></img>
					<p class="choose-text">דיסקרטי</p>
					<p style="text-align: center;">לורם איפסום דולור סיט אמט, קונסקטורר אדיפיסינג אלית להאמית קרהשק סכעיט דז מא, מנכם למטכין נשואי מנורך. גולר </p>
				</div>
			</div>
